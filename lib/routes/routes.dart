...
import 'package:jam_re_store/pages/auth/sign_in/sign_in_mail_page.dart';
import 'package:jam_re_store/pages/auth/sign_up/create_password_page.dart';
import 'package:jam_re_store/pages/auth/sign_up/select_topics_page.dart';
import 'package:jam_re_store/pages/auth/sign_up/sign_up_mail_page.dart';
...
var routes = <String, WidgetBuilder>{
  ...
  NamesRoutes.signUpMail: (context) => const SignUpMailPage(),
